...
var uri = "sip:"+login+"@10.111.69.144";
var password = localStorage.getItem("pwd");
var ws_servers = "ws://10.111.69.144:8088/ws";


var configuration = {
    'uri': uri, // FILL SIP URI HERE like sip:sip-user@your-domain.bwapp.bwsip.io
